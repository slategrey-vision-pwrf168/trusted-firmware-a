...
#ifndef QTI_PLATFORM_PM_H
#define QTI_PLATFORM_PM_H
...
/*----------------------------------------------------------------------------*/
/*
 * nord has 18 physical cores distributed across 3 clusters (6 cores per
 * cluster).
 */
...
{                                   \
	1, /* Overall CX Rail */    \
	PLAT_CLUSTER_COUNT,         \
	6, /* 6 cores in cluster 0 */ \
	6, /* 6 cores in cluster 1 */ \
	6, /* 6 cores in cluster 2 */ \
}

#define PLATFORM_CORE_COUNT 18
